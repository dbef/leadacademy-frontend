...
export const paths = {
  ...
  dashboard: {
    ...
    campus: {
      root: `${ROOTS.DASHBOARD}/campus`,
      new: `${ROOTS.DASHBOARD}/campus/new`,
      details: (id: string) => `${ROOTS.DASHBOARD}/campus/${id}`,
      edit: (id: string) => `${ROOTS.DASHBOARD}/campus/${id}/edit`,
    },
    lecturer: {
      root: `${ROOTS.DASHBOARD}/lecturer`,
      new: `${ROOTS.DASHBOARD}/lecturer/new`,
      details: (id: string) => `${ROOTS.DASHBOARD}/lecturer/${id}`,
      edit: (id: string) => `${ROOTS.DASHBOARD}/lecturer/${id}/edit`,
    },
    product: {
