export const termsAndConditions = [
  {
    ...
    points_ka: [
      ...
      'თითოეულ კურსზე მიიღება მაქსიმუმ 50 აპლიკანტი',
  ...
  },
  {
    ...
    points_ka: [
      ...
      'აპლიკანტი, რომელიც შემჩნეული იქნება ზემოხსენებული აკრძალული ნივთირებების გამოყენებაში, გარიცხული იქნება აკადემიიდან.',
    ],
    points_en: [
  ...
  },
  {
    ...
    points_ka: [
      ...
      'საბოლოო დასტურს მიიღებთ ელექტრონული ფოსტის საშუალებით, აპლიკანტის აკადემიური მაჩვენებლებისა და სხვა კრიტერიუმების შეფასების შემდეგ',
