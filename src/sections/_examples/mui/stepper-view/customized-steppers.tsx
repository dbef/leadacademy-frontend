...
export function ColorlibStepIcon(props: StepIconProps) {
  ...
  const icons: {
    ...
    1: <Iconify icon="hugeicons:course" width={24} />,
    2: <Iconify icon="material-symbols:family-restroom" width={24} />,
    3: <Iconify icon="mdi:account-student" width={24} />,
    4: <Iconify icon="solar:medical-kit-bold" width={24} />,
  };
